...
public:
   ...
   *   @param bindPort true if port must be bind to the application
   *   @exception SocketException thrown if setting local port fails
   */
  void setLocalPort(unsigned short localPort, bool bindPort) throw(SocketException);
   ...
   *   @param localPort local port
   *   @isBind if true the socket is bound to the address and port
...
public:
   ...
   */
  int send(const char *buffer, int bufferLen) throw(SocketException);
...
public:
  ...
  *   @param localAddress local address
  *   @param localPort local port
  *   @param bind true if bind the socket
  *   @exception SocketException thrown if unable to create UDP socket
  */
  UDPSocket(const string &localAddress, unsigned short localPort, bool isBind)
	  throw(SocketException);
   ...
   */
  int sendTo(const char *buffer, int bufferLen, const string &foreignAddress,
   ...
   */
  int recvFrom(char *buffer, int bufferLen, string &sourceAddress,
